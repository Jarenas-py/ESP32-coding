...
#define WIFI_SSID     //Enter wifi or data SSID
#define WIFI_PASS     //Enter wifi or data password
#define APP_KEY       //Enter your Sinric Pro App Key
#define APP_SECRET    //Enter your Sinric Pro App Secret Key

// Sinric Device IDs (create 2 Switch devices in SinricPro)
#define DEVICE_ID_1   //Enter your Sinric Pro Device ID
#define DEVICE_ID_2   //Enter your Sinric Pro Device ID
